...
def demo_page(navigate_to_login):
    ...
    st.markdown(
        "<h1 style='text-align: left;'>Capitalized</h1>", unsafe_allow_html=True
    )
    ...
    with left_column:
        st.markdown(
            "<h2 style='text-align: left;'>Get demo by Capitalized</h2>",
            unsafe_allow_html=True,
        )
        st.markdown("### Private and Public Companies")
        st.write(
            "Whether you’re just starting out or running a well-established business, see how Capitalized makes managing equity a breeze."
        )

        st.markdown("### Investors and Fund Managers")
        st.write(
            "Chat with an expert to see how Capitalized helps VCs and fund managers streamline their operations."
        )

        st.markdown("### Compensation Decision-Makers")
        st.write(
            "Find out how Capitalized helps you attract and keep top talent with the world’s largest collection of real-time pay data."
        )
    ...
    with right_column:
        st.markdown(
            "<h2 style='text-align: left;'>Fill The Form & Get New Experience of Valuating Your Company</h2>",
            unsafe_allow_html=True,
        )
        ...
        usage = st.selectbox(
            "I will use this platform for *",
            ["Select Purpose", "Private Companies", "Investors", "Research and Study"],
        )

        # Terms and conditions disclaimer
        st.markdown(
            "By submitting your information, you agree to the processing of your personal data by Capitalized as described in Capitalized's [Privacy Policy](#).",
            unsafe_allow_html=True,
        )
        ...
        if st.button("Back to Login"):
            ...
            st.query_params.from_dict(
                {"page": "login"}
            )  # Update query parameters for login page
